    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests((authorizationManagerRequestMatcherRegistry -> {
            authorizationManagerRequestMatcherRegistry
                    .requestMatchers("/signup", "/signupAccess/", "/signupAccess/", "/login", "/verifyagePage", "/signup-seller","/regist/**","/signupAccess/**","/submitOrder/**","/validateOrder/**", "/presentcomplete" ,"/image-upload/**","/mainpartner","/partner","/upload/**","/proxy/**").anonymous()
